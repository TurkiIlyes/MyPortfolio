    ...
    >
      <div className="relative w-full">
        ...
        <div className="flex justify-end gap-2 mr-10">
          <button
            className="relative z-40 h-10 w-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300 disabled:opacity-50"
            onClick={scrollLeft}
    ...
    <>
      ...
      >
        ...
        <div className="relative w-full z-40 p-8">
          ...
          <motion.p
            layoutId={layout ? `title-${card.title}` : undefined}
            className="text-white text-xl md:text-3xl font-semibold max-w-xs text-left [text-wrap:balance] font-sans mt-4"
          >
            {card.title}
          </motion.p>
        </div>
